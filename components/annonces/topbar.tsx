...
import { Menu, Bell, User, LayoutDashboard, List, MessageSquare, Settings } from "lucide-react";
...
const NAV_ITEMS = [
  { label: "Tableau", href: "/annonceur/dashboard", icon: LayoutDashboard },
  { label: "Annonces", href: "/annonceur/annonces", icon: List },
  { label: "Messages", href: "/annonceur/messages", icon: MessageSquare },
  { label: "Profil", href: "/annonceur/profil", icon: Settings },
];
